...
export declare function validateOptionsWithSchema(registry: schema.SchemaRegistry): <T extends {}>(schematic: FileSystemSchematicDescription, options: T, context?: import("packages/angular_devkit/schematics/src/engine/interface").TypedSchematicContext<import("packages/angular_devkit/schematics/tools/description").FileSystemCollectionDescription, FileSystemSchematicDescription> | undefined) => Observable<T>;
